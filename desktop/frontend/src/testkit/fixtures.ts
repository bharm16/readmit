...
export function shellResult(): ShellResult {
  const shell: Shell = {
    regions: [
      { id: "commands", label: "Search" },
      { id: "navigation", label: "Navigation" },
      { id: "evidence", label: "Main content" },
      { id: "inspector", label: "Message details" },
      { id: "privacy", label: "Status" },
    ],
    indicators: indicatorFixtures(),
    commands: [
      { id: "command-palette", title: "Command palette", keys: "Ctrl+K" },
      { id: "search-workspace", title: "Search this project", keys: "Ctrl+F" },
      { id: "open-workspace", title: "Open…", keys: "Ctrl+O" },
      { id: "maintain-workspace", title: "Storage and backups" },
      { id: "check-staged-upgrade", title: "Updates" },
