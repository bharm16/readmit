// What an interruption journey observes outside the window, from the machine's
// side: whether anything accepts a connection on a loopback address, how many
// entries a folder the application writes holds, and the host's load. The
// journeys run in Node beneath jsdom, so these are ordinary Node calls; they
// read, and never write or connect anywhere but loopback.
