...
const screens: Record<RegionId, { title: string; steps: string; guide: string }> = {
  ...
  privacy: { title: "Control access and disclosure", steps: "Evidence read, verify and export remain available after expiry. New paid work needs explicit local activation and a valid clock state. Keep credentials in their approved store. Review a support bundle locally before any manual transfer; hidden values do not make screenshots or notes safe to share.", guide: "support.md" },
};
