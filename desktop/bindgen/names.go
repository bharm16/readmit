...
var facadeNames = names{
	...
	vocabularies: map[string][]string{
		...
		// The names the interruptible operations hold the slot under that a
		...
		"InterruptibleOperation": {
			...
			"internal/desktop.corpusOperation",
			...
			"internal/desktop.replayOperation",
			"internal/desktop.replayPreviewOperation",
			"internal/desktop.runComparisonOperation",
