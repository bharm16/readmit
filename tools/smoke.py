...
REQUIRED_FILES = {
    ...
    "docs/profile-library.md",
    "testdata/fixtures/profile-pack-adt.json",
    "testdata/fixtures/profile-pack-overlapping.json",
    "testdata/fixtures/profile-pack-pending-review.json",
    "docs/local-profiles.md",
    ...
    "testdata/fixtures/normalize-before.mllp",
    "testdata/fixtures/normalize-after.mllp",
    "testdata/fixtures/normalize-policy.json",
    "testdata/fixtures/normalize-policy-refused.json",
    "testdata/fixtures/normalize-expected.json",
    ...
    "docs/synth.md",
    "docs/diagnose.md",
    "docs/finding-review.md",
    "testdata/fixtures/finding-decisions.json",
    "testdata/fixtures/finding-decisions-refused.json",
    "docs/correlate.md",
    "docs/transform.md",
    "docs/reduction.md",
    ...
    "licenses/github.com-golang-sql-civil-LICENSE.txt",
    "licenses/github.com-golang-sql-sqlexp-LICENSE.txt",
    "licenses/github.com-google-uuid-LICENSE.txt",
    "licenses/github.com-jackc-pgpassfile-LICENSE.txt",
    "licenses/github.com-jackc-pgservicefile-LICENSE.txt",
    "licenses/github.com-jackc-pgx-v5-LICENSE.txt",
    "licenses/github.com-jackc-puddle-v2-LICENSE.txt",
    "licenses/github.com-microsoft-go-mssqldb-LICENSE.txt",
    "licenses/github.com-shopspring-decimal-LICENSE.txt",
    "licenses/github.com-sijms-go-ora-v2-LICENSE.txt",
    "licenses/golang.org-x-crypto-LICENSE.txt",
    "licenses/golang.org-x-sync-LICENSE.txt",
    "licenses/golang.org-x-text-LICENSE.txt",
    "licenses/mssql-vendored-mssql-always-encrypted-LICENSE.txt.txt",
    "licenses/mssql-vendored-npipe.v2-LICENSE.txt.txt",
    "licenses/golang.org-x-crypto-PATENTS.txt",
    "licenses/golang.org-x-sync-PATENTS.txt",
    "licenses/golang.org-x-text-PATENTS.txt",
