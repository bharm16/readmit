...
var slotActivities = []slotActivity{
	...
	},
	{
		...
		ops: []namedOperation{
			...
			{replayPreviewOperation, "A replay preview is in progress now; it opens no connection, and with a send policy selected it resolves the target's host name, as a send-policy evaluation does."},
