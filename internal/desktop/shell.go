...
var supportStatus = Support{
	...
	Unavailable: []string{
		...
		"archive or delete a project after explicit confirmation and selection match",
		"change project settings and declare interface versions",
		...
		"choose customer hub configuration through native dialog",
		"choose the local folder a reviewed support bundle is published into",
		...
		"declare retained-file quota limits for a project",
		"decode pasted canonical suite JSON for the structured editor",
		...
		"inspect a retained baseline and its local approval",
		"inspect a retained release and its local approval",
		...
		"prepare one job document's spec and report its input identity and environment binding without sending",
		...
		"preview supported schema migration without rewriting evidence",
		"propose expectations a reviewed run supports, recording none",
		"publish artifact to customer hub project with author admission",
		...
		"reopen a saved sharing policy",
		"reopen a saved transform plan",
		"reopen an installed recurring schedule policy with its entries and the hub's policy identity",
		...
		"save a hub runner-policy revision adding or replacing this runner's grant",
		"save a relationship-preserving transform plan with its rules and profile pins",
		"save a validated runner configuration as a new private file",
		"save a validated runner job document for an explicitly chosen job id",
		"save a validated scenario document without overwriting another entry",
		"save an observation source",
		"save an observation window",
		"save approved destination prefixes atomically",
		...
		"verify value-free support diagnostics offline",
